...
def main():
    ...
    if 'active_subtab' not in st.session_state:  # Track subtab state
    ...
    # Geostrap Tab
        ...
        # Geostrap Parameters Subtab
            ...
            with st.container():
                ...
                # PREVIOUS BUTTON (Geostrap Parameters → Soil Parameters)
