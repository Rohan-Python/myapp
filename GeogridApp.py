...
def main():
    ...
    with tab1:
        ...
        with col1:
            ...
            normal_stress = st.number_input("Normal Stress (kPa):", value=None, placeholder="Enter value", step=0.1, format="%.2f")
            phi = st.number_input("Φ' (degrees):", value=None, placeholder="Enter value", step=0.1, format="%.1f")
            cohesion = st.number_input("Cohesion c' (kPa):", value=None, placeholder="Enter value", step=0.1, format="%.2f")
            unit_weight = st.number_input("Unit Weight (kN/m³):", value=None, placeholder="Enter value", step=0.1, format="%.2f")
            water_content = st.number_input("Water Content (%):", value=None, placeholder="Enter value", step=0.1, format="%.1f")
    ...
    with tab2:
        ...
        with col1:
            ...
            md_aperture = st.number_input("MD Aperture (mm):", value=None, placeholder="Enter value", step=0.1, format="%.1f", 
                                         key="md_aperture", on_change=update_bearing_members)
            cmd_aperture = st.number_input("CMD Aperture (mm):", value=None, placeholder="Enter value", step=0.1, format="%.1f", 
            ...
            if length and md_aperture and cmd_aperture:
                fig = draw_geogrid(float(length), float(md_aperture), float(cmd_aperture), st.session_state.scale_factor)
                st.pyplot(fig)
